...
TEST_LIMIT = 5  # Set to None to process all files
...
def main():
    ...
    if TEST_LIMIT is not None:
        ...
        print(f"⚠️  TEST MODE: Processing only {TEST_LIMIT} files")
    ...
    for i, file_path in enumerate(files):
        try:
            ...
            # before moving .in), just move the .in over and continue without re-calling API.
            ...
            print(f"Processing {i+1}/{total}: {file_path.name}...")
