"""
LLM Inference — Llama 3.1 8B (Few-shot)
Citation prediction on 250-file subset via Ollama local.

Usage:
  python llm_inference_llama.py
"""
...
OUTPUT_DIR  = Path("./data_outputs/task2/cocitation_results/predictions/llama3_1_8b")
...
def main():
    ...
    print(f"{'='*50}")
    print("\nNext step:")
    print("  python error_analysis.py --model llama3_1_8b")
